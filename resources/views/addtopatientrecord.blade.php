                ...
                <div class="midde_cont">
                    <div class="container-fluid">
                        ...
                        <div class="row column3">
						    ...
						    @endif
							<form action="{{ route('addecounter.store') }}" method="POST" enctype="multipart/form-data">
							    @csrf
							    <!-- Hidden Fields for by_who_name and by_who_email -->
							    <input type="text" name="by_who_name" value="{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}" class="form-control">
