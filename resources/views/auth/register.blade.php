<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <div  class="mt-4">
            ...
            <x-text-input id="intro" class="block mt-1 w-full" type="text" name="intro" :value="old('intro')" required autofocus autocomplete="intro" />
            <x-input-error :messages="$errors->get('intro')" class="mt-2" />
        </div>

        <div  class="mt-4">
            <x-input-label for="years_of_experience" :value="__('Years of Experience')" />
            <x-text-input id="years_of_experience" class="block mt-1 w-full" type="number" name="years_of_experience" :value="old('years_of_experience')" required autofocus autocomplete="years_of_experience" />
