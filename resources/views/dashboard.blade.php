            ...
            <nav id="sidebar">
                    ...
                    <div class="sidebar_user_info">
                        ...
                        <div class="user_profle_side">
                            <div class="user_img"><img class="img-responsive"
                                    src="https://th.bing.com/th/id/OIP.KgxWIJeuFzqf6EWcmhpp6AHaHa?w=512&h=512&rs=1&pid=ImgDetMain"
                                    alt="#" /></div>
                            <div class="user_info">
                ...
                <div class="sidebar_blog_2">
                    ...
                    <ul class="list-unstyled components">
                        <li class="active">
                            <a href="#dashboard" data-toggle="collapse" aria-expanded="false" class=""><svg
                                    ...
                                    <div class="dash_blog_inner">
                                        <div class="dash_head">
                                            <h3><span>
                                                    ...
                                                    |Today's Tasks</span><span class="plus_green_bt"></span></h3>
                                        </div>
                                        <div class="list_cont">
